...
| [Kana](Kana/) | A strong-willed yet irresistibly cute taekwondo girl with a vivid red bob and a crisp white dobok. | <img src="Kana/screenshots/kana-idle.png" alt="Kana" width="96"> |
...
| [Yura](Yura/) | A mysterious moonlit chibi girl with a long blue-black braid and an indigo kimono. | <img src="Yura/screenshots/yura-idle.png" alt="Yura" width="96"> |
...
Codex 데스크톱 앱에서 사용할 수 있는 오리지널 치비 소녀 애니메이션 펫 컬렉션입니다. 현재 미유, 히나, 리나 자매와 요정 마법소녀 루미, 여름 원피스 캐릭터 나미, 신비로운 기모노 캐릭터 유라, 태권도복을 입은 강인하고 귀여운 카나를 제공합니다.
